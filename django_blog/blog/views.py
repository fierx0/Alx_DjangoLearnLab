...
from taggit.models import Tag  # taggit tags
...
# ---------------------------
# Post CRUD (tags via taggit)
# ---------------------------

class PostCreateView(LoginRequiredMixin, CreateView):
    model = Post
    form_class = PostForm  # fields: title, content, tags
...
class CommentCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = "blog/comment_form.html"  # rarely used; form is in post_detail
...
class PostByTagListView(ListView):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .filter(tags__slug=self.tag.slug)
        )
